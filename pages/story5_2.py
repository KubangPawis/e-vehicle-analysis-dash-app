...
story5_2_layout = html.Div([
        html.Div([
            html.Div([
                html.Div([
                    html.Div([
                        html.H1('Even at high prices, the performance of PHEVs do not really increase. This explains why BEVs are more in demand the PHEVs.')
        ...
        html.Div([
            dcc.Link('>>', href='/end', className='story-next-btn change-color-hover')
